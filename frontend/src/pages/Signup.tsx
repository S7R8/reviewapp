      ...
      <main className="w-full max-w-md">
        <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <label className="flex flex-col w-full">
              ...
              <div className="relative flex w-full items-center">
                <User className="absolute left-3 text-[#6B7280]" size={20} />
                <input
                  type="text"
                  value={name}
            ...
            >
              {isLoading ? (
                ...
                <span className="truncate">アカウント作成</span>
              )}
            </button>
          </form>
          ...
          <div className="flex flex-col gap-4">
            ...
            <button className="flex h-12 w-full cursor-pointer items-center justify-center gap-3 overflow-hidden rounded-lg border border-gray-300 bg-white px-5 text-base font-medium leading-normal text-[#111827] transition-colors hover:bg-gray-50">
              ...
              <span className="truncate">Googleでサインアップ</span>
            </button>
            ...
            <button className="flex h-12 w-full cursor-pointer items-center justify-center gap-3 overflow-hidden rounded-lg border border-gray-300 bg-white px-5 text-base font-medium leading-normal text-[#111827] transition-colors hover:bg-gray-50">
              ...
              <span className="truncate">GitHubでサインアップ</span>
            </button>
          </div>
        </div>
        ...
        <div className="pt-6">
          <p className="text-[#6B7280] text-sm font-normal leading-normal text-center">
            すでにアカウントをお持ちですか？{' '}
            <Link to="/login" className="font-bold text-[#F4C753] hover:underline">
              ログインはこちら
            </Link>
          </p>
        </div>
